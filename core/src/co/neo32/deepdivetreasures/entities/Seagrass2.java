...
public class Seagrass2 extends Actor {
    ...
    public Seagrass2(PositionComponent position) {
        ...
        frames = new Sprite[2];
        for (int i = 0; i < 2; i++) {
            frames[i] = new Sprite(new Texture(Gdx.files.internal("sprites/seagrass2.png")), i * spriteWidth, 0, spriteWidth, spriteHeight);
        }
